...
namespace CargoDesk.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250724085438_WorkSessionsTableNewField")]
    partial class WorkSessionsTableNewField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CargoDesk.Infrastructure.Persistence.Entities.RouteEntity", b =>
                {
                    ...
                    b.HasIndex("CargoId")
                        .IsUnique()
                        .HasDatabaseName("ix_routes_cargo_id");
            ...
            modelBuilder.Entity("CargoDesk.Infrastructure.Persistence.Entities.RouteEntity", b =>
                {
                    b.HasOne("CargoDesk.Infrastructure.Persistence.Entities.CargoEntity", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_routes_cargos_cargo_id");
