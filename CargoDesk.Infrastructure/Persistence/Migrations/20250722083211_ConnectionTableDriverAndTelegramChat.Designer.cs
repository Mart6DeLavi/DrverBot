...
namespace CargoDesk.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250722083211_ConnectionTableDriverAndTelegramChat")]
    partial class ConnectionTableDriverAndTelegramChat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CargoDesk.Infrastructure.Persistence.Entities.Telegram.DriverChatEntity", b =>
                {
                    b.Property<Guid>("DriverId")
                        .HasColumnType("uuid")
                        .HasColumnName("driver_id");
            ...
            modelBuilder.Entity("CargoDesk.Infrastructure.Persistence.Entities.CargoEntity", b =>
                {
                    ...
                    b.HasOne("CargoDesk.Infrastructure.Persistence.Entities.RouteEntity", "RouteEntity")
                        .WithOne("Cargo")
                        .HasForeignKey("CargoDesk.Infrastructure.Persistence.Entities.CargoEntity", "RouteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
